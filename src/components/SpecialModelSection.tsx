...
import { Reveal, StaggerReveal, StaggerItem, Magnetic } from '@/components/ui/MotionElements'
        ...
        <div className="text-center space-y-16">
          ...
          <div className="space-y-6">
            <Reveal variant="fadeUp">
              <div className="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-200 rounded-full text-gray-700 text-sm font-medium">
                <span className="w-2 h-2 bg-gray-400 rounded-full mr-2 animate-pulse-ring"></span>
                3D Print Texnologiyası
              </div>
            </Reveal>
            
            <Reveal variant="fadeUp" delay={0.1}>
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight font-title">
                Xüsusi NFC{' '}
          ...
          <StaggerReveal className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-bold text-gray-900 font-title">Fərdi dizayn</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-bold text-gray-900 font-title">NFC inteqrasiya</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-bold text-gray-900 font-title">Yüksək keyfiyyət</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-bold text-gray-900 font-title">Sürətli hazırlıq</h3>
          ...
          <Reveal variant="fadeUp" delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Magnetic strength={0.2}>
                <a 
                  href="#contact" 
                  className="inline-flex items-center px-8 py-4 bg-transparent border-2 border-gray-900 text-gray-900 font-medium rounded-full hover:bg-gray-900 hover:text-white transition-all duration-300 group btn-lift"
                >
                  Əlaqə saxla
                </a>
              </Magnetic>
              ...
              <Magnetic strength={0.2}>
                <a 
                  href="#examples" 
                  className="inline-flex items-center px-8 py-4 bg-gray-900 border-2 border-gray-900 text-white font-medium rounded-full hover:bg-transparent hover:text-gray-900 transition-all duration-300 group btn-lift"
                >
                  Nümunələrə bax
                </a>
              </Magnetic>
