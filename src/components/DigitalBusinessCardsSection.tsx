            ...
            <div className="space-y-6">
              <Reveal variant="fadeUp">
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight font-title">
                  Yeni nəsil <span className="text-gradient">smart</span><br />vizitkartlar<br />nədir?
                </h2>
              </Reveal>
            ...
            <StaggerReveal className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <StaggerItem>
                  <div className="bg-white rounded-3xl shadow-lg overflow-hidden card-hover">
                    ...
                    <div className="p-8 space-y-4">
                      <h3 className="text-xl font-bold text-gray-900 font-title">Digital profil</h3>
              ...
              <div className="space-y-6">
                ...
                <StaggerItem>
                  <div className="bg-white rounded-3xl shadow-lg overflow-hidden card-hover">
                    ...
                    <div className="p-6 space-y-3">
                      <h3 className="text-xl font-bold text-gray-900 font-title">Ani paylaşım</h3>
                ...
                <StaggerItem>
                  <div className="bg-white rounded-3xl shadow-lg overflow-hidden card-hover">
                    <div className="p-8 space-y-4">
                      <h3 className="text-xl font-bold text-gray-900 font-title">Cihaz dəstəyi</h3>
                      <p className="text-gray-600 leading-relaxed">
